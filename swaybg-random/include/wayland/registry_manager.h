...
namespace wayland {
    ...
    public:
        ...
        constexpr const std::vector<shared_global> &globals() { return m_objects; }
    ...
    class registry_manager {
        ...
        void bind_helper(uint32_t name, const char *interface, uint32_t available_version) {
            ...
            if (strcmp(interface, wl_interface.name) == 0 && available_version >= min_version) {
    ...
    public:
        explicit registry_manager(std::shared_ptr<display> display) :
